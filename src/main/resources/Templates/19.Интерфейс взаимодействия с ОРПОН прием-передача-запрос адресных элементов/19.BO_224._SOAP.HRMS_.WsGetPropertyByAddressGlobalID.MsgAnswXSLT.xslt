...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="PropertyByGlobalIDB2BResponse!=''">
				<Confirmation>
					<ResultCode>
						<xsl:value-of select="/PropertyByGlobalIDB2BResponse/ResultCode"/>
					</ResultCode>
					<Message>
						<xsl:value-of select="/PropertyByGlobalIDB2BResponse/ResultText"/>
					</Message>
					<DetailList>
						<xsl:for-each select="PropertyByGlobalIDB2BResponse/FoundProperty">
							<FoundProperty>
								<PropertyGlobalID>
								...
								<xsl:copy-of select="/PropertyByGlobalIDB2BResponse/FoundProperty/ExternalIdList"/>
								<Name>
