...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="ResponseO2OCRMexecSub!=''">
				<Confirmation>
					<ResultCode>
						<xsl:value-of select="/ResponseO2OCRMexecSub/responseCode"/>
					</ResultCode>
					<Message>
						<xsl:value-of select="/ResponseO2OCRMexecSub/responseBody"/>
					</Message>
					<DetailList>
						<ResponseFromExternalSystem>
								...
								<xsl:if test="/ResponseO2OCRMexecSub/responseCode != '0' ">
							...
							<subId>
								<xsl:value-of select="/ResponseO2OCRMexecSub/subId"/>
							</subId>
						</ResponseFromExternalSystem>
					</DetailList>
					<Next>RESOUT</Next>
