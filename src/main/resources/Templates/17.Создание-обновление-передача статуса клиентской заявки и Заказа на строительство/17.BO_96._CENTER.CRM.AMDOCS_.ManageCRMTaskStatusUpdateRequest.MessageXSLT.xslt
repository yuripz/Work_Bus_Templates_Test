					...
					<orderParties>
						<orderParty>
							...
							<partyAttributes>
								...
								<!--<attribute name="url">https://hermes-beta.rt.ru/aggregator/<xsl:value-of select="OrderOMSId"/></attribute>-->
								<attribute name="url">
						...
						<orderParty>
							...
							<partyAttributes>
								...
								<attribute name="CustomerProjectId">
									<xsl:value-of select="/CRMTaskStatusUpdate/SYSProjectAnalytics/CustomerProjectId"/>
								</attribute>
								<attribute name="PONR">
									<xsl:choose>
												...
												<attribute name="equipmentList">
													<xsl:for-each select="eq">
														<equipment>
															...
															<xsl:if test="EQ_NODEFUNCTIONS!= '' or EXCLUSIVECOMMENT!= '' ">
																<attributes>
										...
										<xsl:if test="/CRMTaskStatusUpdate/ChosenPTVInfo/EQ_ID!='' and /CRMTaskStatusUpdate/ChosenPTVInfo/SOLUTION_ID=''">
											<attribute name="equipmentList">
												<equipment>
													...
													<xsl:if test="/CRMTaskStatusUpdate/ChosenPTVInfo/EQ_NODEFUNCTIONS!= '' or /CRMTaskStatusUpdate/ChosenPTVInfo/EXCLUSIVECOMMENT!= '' ">
														<attributes>
