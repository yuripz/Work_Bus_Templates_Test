...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <onlineWsSearchAddrElByFullNameResponse>
   <xsl:choose>
<xsl:when test="/Confirmation/DetailList/Detail">

       <ResultCode><xsl:value-of select="/Confirmation/ResultCode"/></ResultCode>
    <Message><xsl:value-of select="/Confirmation/Message"/>
    </Message>
...
<!-- <xsl:copy-of select="DetailList/Detail"/> -->
  ...
  <ResultCode>-1020304</ResultCode>
    <Message>Пришло пустое сообщение о распознавании</Message>
  </xsl:otherwise>
 </xsl:choose>
   </onlineWsSearchAddrElByFullNameResponse>
